...
ENEMIES: Dict[str, Dict] = {
    # Forest (low-mid)
    "wolf":         {"name": "Wolf",          "hp": 8, "atk": 5,  "def": 1, "xp": 16, "gold": 6},
    "boar":         {"name": "Wild Boar",     "hp": 14, "atk": 6,  "def": 2, "xp": 20, "gold": 8},
    "bandit":       {"name": "Bandit",        "hp": 22, "atk": 7,  "def": 2, "xp": 22, "gold": 10},
    "giant_spider": {"name": "Giant Spider",  "hp": 20, "atk": 8,  "def": 1, "xp": 22, "gold": 9},

    # Dark forest
    "cultist":      {"name": "Cultist",       "hp": 30, "atk": 9,  "def": 3, "xp": 34, "gold": 14},
    "wraith":       {"name": "Wraith",        "hp": 28, "atk": 10, "def": 2, "xp": 36, "gold": 12},
    "dire_wolf":    {"name": "Dire Wolf",     "hp": 34, "atk": 10, "def": 4, "xp": 42, "gold": 16},

    # Rare tough enemies
    "ogre":         {"name": "Ogre",          "hp": 60, "atk": 13, "def": 6, "xp": 90, "gold": 40},
    "necromancer":  {"name": "Necromancer",   "hp": 52, "atk": 14, "def": 5, "xp": 100,"gold": 50},
}

ENEMIES_BY_LOCATION: Dict[str, List[str]] = {
    "forest": ["boar","bandit","giant_spider"],
    "dark_forest": ["cultist","wraith","dire_wolf","ogre","necromancer"],
}
